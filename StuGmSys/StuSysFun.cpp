...
* @version:v1.0
* @author:chenjunlong
* @description:Store the implementation function of the student management system.
...
*           FUCTION:
                    管理员对学生信息的操作：
                        ...
                        8、······
            BUGFIX:
                    [2023.03.20]修复系统主菜单在输入非法指令时退出系统的bug，增加输错指令提示并让用户重新输入的功能。
                    [2023.03.20]修复输入的指令不为数字时，系统奔溃的bug。
                    
            MODIFY:
                    [2023.03.20]添加了显示学生信息时，统计和显示系统中学生数量的功能。
                    [2023.03.20]增加了修改信息时，是否保存修改的功能。
